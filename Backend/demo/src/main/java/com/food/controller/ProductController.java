...
public class ProductController {
	...
	public List<Product> getAllProducts() {
		...
		if(prodList.isEmpty()) {
			...
			addProdIfEmpty(new Product(1,"Chicken","Rice Steamed with Chicken and spices","Indian",365,10,0,"yes",""));
			addProdIfEmpty(new Product(2,"Rice","Rice with Egg and Chinese sauses","Chinese",95,5,0,"yes",""));
			addProdIfEmpty(new Product(3,"Pizza","Pizza topped with cotted cheese and vegies","Italian",435,0,0,"yes",""));
			addProdIfEmpty(new Product(4,"Pasta","Pasta with Tomato and oregano","Italian",435,0,0,"yes",""));
			addProdIfEmpty(new Product(5,"Ravioli","Ravioli pasta filled with veg mince","Italian",200,18,0,"yes",""));
			addProdIfEmpty(new Product(6,"Elote de Corn","Corn topped with cream cheese and spice","Mexican",180,7,0,"yes",""));
			addProdIfEmpty(new Product(7,"Burrito","Wrapped Tortilla with Meat mince and Mayo","Mexican",350,0,0,"yes",""));
